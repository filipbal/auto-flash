...
class AutomateFlashService(QWidget):
    ...
    def init_ui(self):
        ...
        self.variants = {
            ...
            "TOY18DAD800": ["1BE0  (MO=TOY600, D2=HAM, TG)", "2BE0  (MO=TOY600, D2=HAM, TG)", "4BE0  (MO=TOY600, D2=HAM, TG)", "SBE0  (MO=TOY600, D2=HAM, TG)", "1EE0  (MO=TOY800, D2=HAM, TG, EX)", "2EE0  (MO=TOY800, D2=HAM, TG, EX)", "4EE0  (MO=TOY800, D2=HAM, TG, EX)", "SEE0  (MO=TOY800, D2=HAM, TG, EX)"],
            ...
            "BABY18DAD800": ["1BE0  (MO=TOY800, D2=S2D2)", "2BE0  (MO=TOY800, D2=S2D2)", "4BE0  (MO=TOY800, D2=S2D2)", "SBE0  (MO=TOY800, D2=S2D2)"]
        }
