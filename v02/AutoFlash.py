...
# Define versions
VERSION_AUTOFLASH = '0.2'
VERSION_FLASHSRV = '5.54'
...
class AutomateFlashService(QWidget):
    ...
    def init_ui(self):
        ...
        self.variants = {
            ...
            "TOY18DAD600": ["2BE0  (MO=TOY600, D2=HAM)","1EE0  (MO=TOY600, D2=HAM, EX)", "2EE0  (MO=TOY600, D2=HAM, EX)", "4EE0  (MO=TOY600, D2=HAM, EX)", "SEE0  (MO=TOY600, D2=HAM, EX)"],
    ...
    def on_click(self):
        ...
        for i in range(QUANTITY):
            ...
            if instance == 1:
                app_title = f"ECOM Flash Service v" + VERSION_FLASHSRV + " (zvoljml)"
            else:
                app_title = f"-{instance}- ECOM Flash Service v" + VERSION_FLASHSRV + " (zvoljml)"
            ...
            # Send left arrow to move to "Ano"
            keyboard.send_keys("{LEFT}")
            time.sleep(1)

            # Send Enter to confirm 1x Gain for EX detector
            keyboard.send_keys("{ENTER}")
            # Wait 5 seconds
            time.sleep(5)
